...
install_system_deps() {
  ...
  if ! yay -S --noconfirm --needed base-devel gcc make yazi ffmpeg 7zip ouch jq sshfs rsync poppler lsof fzf tumbler zoxide glow grc eza tree-sitter-cli npm pandoc-cli nwg-displays resvg imagemagick ueberzugpp git ripgrep fd unzip neovim trash-cli bat fastfetch stow man-db less zsh; then
