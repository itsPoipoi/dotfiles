...
alias ts="\tailscale status"
alias {tup,ton}="tailscale up"
alias {twn,toff}="tailscale down"
alias texon="tailscale up --reset --login-server=https://headscale.poipoi.ovh --ssh --exit-node=pi"
alias texoff="tailscale up --reset --login-server=https://headscale.poipoi.ovh --ssh"
